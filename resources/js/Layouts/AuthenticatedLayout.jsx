...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-50">
            ...
            <main className="flex">
                <nav className="flex flex-col h-[calc(100vh-70px)] gap-12 p-8 pt-12 bg-white w-52">
                    <LeftNavButton route={route("dashboard")} text={"Accueil"}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <LeftNavButton route={route("conversations")} text={"Chat"}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <LeftNavButton route={"agenda"} text={"Agenda"}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <LeftNavButton route={/*route("tickets")*/ 0} text={"Mes tickets"}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
