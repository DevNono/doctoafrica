...
export default function NotificationBell(notification = false) {
        ...
        <>
            <div className="relative flex h-full">
                ...
                >
                    ...
                    {notification && <div className="absolute bottom-[1px] right-[1px] w-[7px] h-[7px] bg-red-500 rounded-full"></div>}
                </button>
                {showingNotificationsDropdown && (
