...
export default function MainSearchBar() {
    ...
    const [searchQuery, setSearchQuery] = useState('AZWSFVSCSDV');
    ...
    return <>
        <div className="relative items-center justify-center flex-1 hidden w-80 lg:flex">
            <input type="text" placeholder="Rechercher" onChange={(e) => {setSearchQuery(e.target.value)}} className="w-full px-4 py-2 text-gray-600 bg-gray-100 border-0 rounded-full outline-none focus:outline-none focus:shadow-outline" />
